...
order to use this module. Working implementations of PKCS#11 librarys
include:
...
PKCS11.new requires suitable PKCS #11 implementation as UN*X *.so file or Windows-DLL.
